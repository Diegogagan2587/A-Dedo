...
const CarRegister = () => {
  ...
  return (
    <main className="mt-20">
      <h2 className='text-textColor font-extrabold text-mainTitle text-[26px] text-center font-baloo'>Ultimo paso</h2>
      <p className="text-center text-[18px]">Carga los datos de tu auto</p>

      <section className="flex flex-col m-6">
        <form action="">
          <h2 className="font-semibold font-roboto-flex">Marca y modelo</h2>
          <Input 
            type="text"
      ...
      <section className="m-6">
        <h2 className="text-[20px] font-roboto-flex">Foto del auto y la patente</h2>
